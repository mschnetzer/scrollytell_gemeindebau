...
::: {.column-screen style="background-image:url(data/kmh-plan.jpg); background-size: 100vw; height: 250px; background-position: center +0%; background-repeat: no-repeat;"}
:::
